...
class AccountController extends Controller
{
    ...
    public function update(UpdateAccountRequest $request)
    {
        ...
        success('اطلاعات حساب کاربری شما با موفقیت آپدیت شد.');
    ...
    {
        return view('frontend.accounts.password');
    }
    ...
    public function updatePassword(UpdatePasswordRequest $request)
    {
        ...
        success('پسورد حساب کاربری شما با موفقیت آپدیت شد.');
    ...
    public function address()
    {
        ...
        return view('frontend.accounts.address', compact('provinces', 'userAddress'));
    }
    ...
    public function updateAddress(UpdateAddressRequest $request)
    {
        ...
        success('آدرس شما با موفقیت آپدیت شد.');
