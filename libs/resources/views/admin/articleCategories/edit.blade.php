                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="nav-tabs-custom no-shadow">
                            ...
                            <form action="{{route('admin.article_category.update', $category->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                                <div class="tab-content">
                                    <div id="tab_general" class="tab-pane active">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="name" id="name" placeholder="نام دسته بندی را وارد کنید" value="{{old('name',$category->name)}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="slug" class="col-md-2 control-label">اسلاگ</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="slug" id="slug" value="{{old('slug',$category->slug)}}" dir="ltr">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <select id="category_id" name="category_id" class="form-control">
                                                    ...
                                                    @foreach($categories as $id=>$cat)
                                                        <option value="{{$id}}" {{($id==old('category_id',$category->parent_id))? 'selected' : ''}}>{{$cat}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        @if($category->image)
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <img src="{{ asset(image_resize($category->image, ['width' => 40, 'height' => 40])) }}" alt="{{$category->name}}">
                                                </div>
                                            </div>
                                        @endif
                                        @if($category->image)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <textarea type="text" class="form-control" name="description" id="description" >{{old('description',$category->description)}}</textarea>
                                            </div>
                                        </div>
                                    </div>
