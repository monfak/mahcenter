        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="nav-tabs-custom no-shadow">
                    ...
                    <form method="post" action="{{ route('admin.categories.update', $category->id) }}" role="form" enctype="multipart/form-data" class="form-horizontal">
                        @method('PUT')
                        @csrf
                        <div class="tab-content">
                            <div id="tab_general" class="tab-pane active">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="label" id="label" class="form-control" value="{{ old('label', $category->label) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div id="tab_seo" class="tab-pane">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="twitter_title" id="twitter_title" class="form-control" value="{{ old('twitter_title', $category->twitter_title) }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="twitter_description" class="col-md-2 control-label">دسکریپشن برای توئیتر</label>
                                        <div class="col-md-10">
                                            <textarea name="twitter_description" id="twitter_description" class="form-control" rows="5">{{ old('twitter_description', $category->twitter_description) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <img src="{{ asset(image_resize($category->og_image, ['width' => 60, 'height' => 60])) }}" alt="{{ $category->name }}">
                                        </div>
                                    </div>
                                    @endif
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <img src="{{ asset(image_resize($category->twitter_image, ['width' => 60, 'height' => 60])) }}" alt="{{ $category->name }}">
                                        </div>
                                    </div>
                                    @endif
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="canonical" id="canonical" class="form-control" value="{{ old('canonical', $category->canonical) }}" dir="ltr">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="is_nofollow" class="col-md-2 control-label mt-2">نوفالو</label>
                                        <div class="col-md-10">
                                            <input type="checkbox" name="is_nofollow" id="is_nofollow" value="1" data-width="100" data-toggle="toggle" data-onstyle="danger" data-on="<i class='fa fa-close'></i> نوفالو" data-off="<i class='fa fa-check'></i> فالو"{{ old('is_nofollow', $category->is_nofollow) ? ' checked' : '' }}>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="is_noindex" class="col-md-2 control-label mt-2">نوایندکس</label>
                                        <div class="col-md-10">
                                            <input type="checkbox" name="is_noindex" id="is_noindex" value="1" data-width="100" data-toggle="toggle" data-onstyle="danger" data-on="<i class='fa fa-close'></i> نوایندکس" data-off="<i class='fa fa-check'></i> ایندکس"{{ old('is_noindex', $category->is_noindex) ? ' checked' : '' }}>
                                        </div>
                                    </div>
                            </div>
                            <div id="tab_information" class="tab-pane">
                                ...
                                <div class="form-group">
                                    @if($category->icon)
                                        <label class="col-md-2 control-label">آیکن</label>
                                        <div class="col-md-10">
                                            <img src="{{ asset(image_resize($category->icon, ['width' => 16, 'height' => 16])) }}" alt="{{ $category->name }}" class="image-thumbnail">
                                        </div>
                                    @endif
                                </div>
                                <div class="form-group">
                                    <label for="icon" class="col-md-2 control-label">{{ ($category->icon ? 'تغییر آیکن' : 'انتخاب آیکن') }}</label>
                                    <div class="col-md-10">
                                        <input type="file" name="icon" id="icon" value="{{ old('icon') }}" class="form-control">
                                    </div>
                                </div>
                                @unless(is_null($category->icon))
                                    <div class="form-group">
                                        <label for="remove_icon" class="col-md-2 control-label">حذف آیکن</label>
                                        <div class="col-md-10">
                                            <input type="checkbox" id="remove_icon" name="remove_icon">
                                        </div>
                                    </div>
                                @endunless
                                <div class="form-group">
                                    @if($category->image)
                                        ...
                                        <div class="col-md-10">
                                            <img src="{{ asset(image_resize($category->image, ['width' => 125, 'height' => 125])) }}" alt="{{ $category->name }}" class="image-thumbnail">
                                        </div>
                                    @endif
                                </div>
                                <div class="form-group">
                                    <label for="image" class="col-md-2 control-label">{{ ($category->image ? 'تغییر تصویر' : 'انتخاب تصویر') }}</label>
                                    <div class="col-md-10">
                                        <input type="file" name="image" id="image" value="{{ old('image') }}" class="form-control">
                                    </div>
                                </div>
                                @unless(is_null($category->image))
                                <div class="form-group">
                                    <label for="remove_image" class="col-md-2 control-label">حذف تصویر</label>
                                    <div class="col-md-10">
                                ...
                                <!--    <div class="col-md-10">-->
                                <!--        <input type="checkbox" id="show" name="show" value="1" {{old("show",$category->show ==1 ? 'checked' : '')}}>-->
                                <!--    </div>-->
                                <!--</div>-->
                                <div class="form-group">
                                    <label for="show_in_menu" class="col-md-2 control-label">نمایش در منو</label>
                                    <div class="col-md-10">
                                        <input type="checkbox" name="show_in_menu" id="show_in_menu" value="1" data-toggle="toggle" data-onstyle="success" data-on="<i class='fa fa-check'></i> فعال" data-off="<i class='fa fa-close text-red'></i> غیرفعال" data-width="100"{{ old('show_in_menu', $category->show_in_menu) ? ' checked' : '' }}>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="has_slider" class="col-md-2 control-label">دارای اسلایدر</label>
                                    <div class="col-md-10">
                                        <input type="checkbox" name="has_slider" id="has_slider" value="1" data-toggle="toggle" data-onstyle="success" data-on="<i class='fa fa-check'></i> فعال" data-off="<i class='fa fa-close text-red'></i> غیرفعال" data-width="100"{{ old('has_slider', $category->has_slider) ? ' checked' : '' }}>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select name="status" id="status" class="form-control">
                                            <option value="0"{{ (old('status', $category->status) == 0 ? 'selected' : '') }}>پیش‌نویس</option>
                                            <option value="1"{{ (old('status', $category->status) == 1 ? 'selected' : '') }}>انتشار</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select name="size_type" id="size_type" class="form-control">
                                            ...
                                            <option value="0"{{ (old('size_type', $category->size_type) === 0 ? 'selected' : '') }}>کالاهای درشت</option>
                                            <option value="1"{{ (old('size_type', $category->size_type) === 1 ? 'selected' : '') }}>کالاهای خورده-ریز</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div id="tab_links" class="tab-pane">
                                ...
                                <div class="form-group">
                                    <label for="attributes" class="col-md-2">گروه خصوصیات</label>
                                    <div class="col-md-8">
                                        <select name="attribute_id[]" id="attributes" class="form-control" multiple="multiple">
                                            @foreach($attributes as $key => $attribute)
                                                <option value="{{ $key }}"{{ (in_array($key, $selectedAttributes) ? ' selected' : '') }}>{{ $attribute }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-8">
                                        <select name="manufacturer_id[]" id="manufacturers" class="form-control" multiple="multiple">
                                            @foreach($manufacturers as $key => $manufacturer)
                                                <option value="{{ $key }}"{{ (in_array($key, old('manufacturer_id') ?? $selectedManufactureres) ? ' selected' : '') }}>{{ $manufacturer }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
