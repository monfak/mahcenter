                ...
                <div class="box-body">
                    <form method="post" action="{{ route('admin.delivery-methods.update', $deliveryMethod->id) }}" role="form" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" id="in_city_price_mask" name="in_city_price_mask" class="form-control mask" value="{{ old('in_city_price_mask', number_format($deliveryMethod->in_city_price, 0, '', ',')) }}">
                                <input type="hidden" name="in_city_price" id="in_city_price" class="price" value="{{ old('in_city_price', number_format($deliveryMethod->in_city_price, 0, '', '')) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="big_floor_price" class="col-md-2 control-label">هزینه طبقه (درشت)</label>
                            <div class="col-md-10">
                                <input type="text" id="big_floor_price_mask" name="big_floor_price_mask" class="form-control mask" value="{{ old('big_floor_price_mask', number_format($deliveryMethod->big_floor_price, 0, '', ',')) }}">
                                <input type="hidden" name="big_floor_price" id="big_floor_price" class="price" value="{{ old('big_floor_price', number_format($deliveryMethod->big_floor_price, 0, '', '')) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="small_floor_price" class="col-md-2 control-label">هزینه طبقه (خورده ریز)</label>
                            <div class="col-md-10">
                                <input type="text" id="small_floor_price_mask" name="small_floor_price_mask" class="form-control mask" value="{{ old('small_floor_price_mask', number_format($deliveryMethod->small_floor_price, 0, '', ',')) }}">
                                <input type="hidden" name="small_floor_price" id="small_floor_price" class="price" value="{{ old('small_floor_price', number_format($deliveryMethod->small_floor_price, 0, '', '')) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="content" class="col-md-2 control-label">توضیحات</label>
                            <div class="col-md-10">
                                <textarea name="content" id="content" class="form-control">{{ old('content', $deliveryMethod->content) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="has_carrige_forward" class="col-md-2 control-label">پس کرایه</label>
                            <div class="col-md-10">
                                <input type="checkbox" name="has_carrige_forward" id="has_carrige_forward" value="1" data-width="125" data-toggle="toggle" data-onstyle="danger" data-on="<i class='fa fa-check'></i> دارد" data-off="<i class='fa fa-close'></i> ندارد"{{ old('has_carrige_forward', $deliveryMethod->has_carrige_forward) ? ' checked' : '' }}>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="is_cover_all" class="col-md-2 control-label">پوشش</label>
                            <div class="col-md-10">
                                <input type="checkbox" name="is_cover_all" id="is_cover_all" value="1" data-width="125" data-toggle="toggle" data-onstyle="danger" data-on="<i class='fa fa-check'></i> همه شهرها" data-off="<i class='fa fa-close'></i> دارای قیمت"{{ old('is_cover_all', $deliveryMethod->is_cover_all) ? ' checked' : '' }}>
                            </div>
                        </div>
                        <div class="form-group">
