...
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                    <form method="POST" id="form" action="{{ route('admin.districts.store') }}" class="form-horizontal" role="form" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="form-group">
                            <label for="name" class="col-md-2 control-label">نام محله *</label>
                            <div class="col-md-10">
                        ...
                        <!-- /.tab-content -->
                        <input type="submit" class="btn btn-primary" value="افزودن محله">
                    </form>
                </div>
            </div>
            <!-- /.box-body -->
