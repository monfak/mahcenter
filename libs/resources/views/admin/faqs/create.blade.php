...
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form method="post" action="{{ route('admin.faqs.store') }}" role="form" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    <div class="form-group">
                        <label for="heading" class="col-md-2 control-label">عنوان</label>
                        <div class="col-md-10">
                    ...
                    <input type="submit" class="btn btn-primary" value="افزودن سوال">
                </form>
            </div>
            <!-- /.box-body -->
        </div>
