        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">ویرایش پلن اقتصاد</h3>
                    <div class="box-tools">
                ...
                <div class="box-body">
                    <div class="nav-tabs-custom no-shadow">
                        <form method="post" action="{{ route('admin.installments.plans.update', $plan->id) }}" role="form" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <select name="is_active" id="is_active" class="form-control">
                                                <option value="0"{{ (old('is_active', $plan->is_active) == 0 ? 'selected' : '') }}>غیرفعال</option>
                                                <option value="1"{{ (old('is_active', $plan->is_active) == 1 ? 'selected' : '') }} >فعال</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
