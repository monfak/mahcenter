    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header with-border">
                <h3>افزودن آیتم به منو {{ $menu->name }}</h3>
                <div class="box-tools">
            ...
            <div class="box-body">
                ...
                <form action="{{ route('admin.menus.items.store', $menu->id) }}" method="post" enctype="multipart/form-data" data-parsley-validate="" role="form" class="form-horizontal">
                    @csrf
                    <div class="tab-content">
                        <div id="tab_general" class="tab-pane active">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="lable" id="lable" class="form-control" value="{{ old('lable') }}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="parent_id" id="parent_id" class="form-control" dir="rtl">
                                        <option value="">فاقد آیتم والد</option>
                                        @foreach($parents as $id => $heading)
                                            <option value="{{ $id }}"{{ (old('parent_id') == $id ? 'selected' : '') }}>{{ $heading }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
