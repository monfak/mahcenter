...
@section('content')
    <div class="callout callout-info">
        ...
        این صفحه برای ایجاد یه کپی سریع از محصولات شما است. لطفا از صفحه برای ویرایش محصولات استفاده نکنید!
    </div>
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">کلون محصول</h3>
                ...
                <div class="box-body">
                    <div class="nav-tabs-custom no-shadow">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#tab_special" data-toggle="tab" aria-expanded="false">قیمت ویژه</a></li>
                        ...
                        <form method="POST" action="{{ route('admin.products.store-clone', $product->slug) }}" id="form" class="form-horizontal" role="form" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_general">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input id="name" type="text" class="form-control" name="name" value="{{ old('name', $product->name) }}" placeholder="عنوان صفحه را وارد کنید" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div id="tab_information" class="tab-pane">
                                    ...
                                    <div class="form-group">
                                        <label for="badge" class="col-md-2 control-label">بج</label>
                                        <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label for="stock" class="col-md-2 control-label">ترتیب نمایش</label>
                                        <div class="col-md-10">
                                            <input type="number" name="sort_order" id="sort_order" class="form-control" value="{{ old('sort_order',$product->sort_order ) }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="suggest" class="col-md-2 control-label">محصول پیشنهادی</label>
                                        <div class="col-md-10">
                                        ...
                                        <div class="col-md-10">
                                            <select name="warranty_id[]" id="warranties" class="form-control" multiple="multiple">
                                                @foreach($warranties as $warrantyId => $warranty)
                                                    <option value="{{ $warrantyId }}"{{ in_array($warrantyId, old('warranty_id', $selectedWarranties)) ? ' selected' : '' }}>{{ $warranty }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <!-- /.tab-content -->
                            <input type="submit" class="btn btn-default" value="افزودن محصول">
                        </form>
                    </div>
                </div>
                <!-- /.box-body -->
