...
@section('scripts')
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#warranties').select2({
                placeholder : 'فیلترها گارانتی‌ها انتخاب کنید',
            });
            $('#products').select2({
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="nav-tabs-custom no-shadow">
                    ...
                    <form method="POST" id="form" action="{{ route('admin.products.store') }}" class="form-horizontal" role="form" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_general">
                                <div class="form-group">
                                    <label for="name" class="col-md-2 control-label">عنوان محصول *</label>
                                    <div class="col-md-10">
                                        <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="عنوان محصول را وارد کنید" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="label" class="col-md-2 control-label">لیبل</label>
                                    <div class="col-md-10">
                                        <input id="label" type="text" class="form-control" name="label" value="{{ old('label') }}" placeholder="لیبل محصول را وارد کنید" required>
                                        <small class="text-muted">این فیلد تا زمان تکمیل فلو خرید لطفا کامل شود و سپس از دو فیلد بعدی استفاده خواهد شد.</small>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="variety_label" class="col-md-2 control-label">لیبل تنوع</label>
                                    <div class="col-md-10">
                                        <input id="variety_label" type="text" class="form-control" name="variety_label" value="{{ old('variety_label') }}" placeholder="مثلا رنگ، سایز و ..." required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="variety_value" class="col-md-2 control-label">مقدار تنوع</label>
                                    <div class="col-md-10">
                                        <input id="variety_value" type="text" class="form-control" name="variety_value" value="{{ old('variety_value') }}" placeholder="مثلا سبز،‌استیل، ۳۸ و ..." required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="slug" class="col-md-2 control-label">اسلاگ محصول *</label>
                                    <div class="col-md-10">
                                        <input id="slug" type="text" class="form-control" name="slug" value="{{ old('slug') }}" placeholder="Enter the page slug" dir="ltr" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="description" class="col-md-2 control-label">توضیحات *</label>
                                    <div class="col-md-10">
                                        <textarea id="description" type="text" class="form-control tinymce" name="description" required>{{ old('description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div id="tab_seo" class="tab-pane">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input id="title" type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="تایتل صفحه محصول را وارد کنید" required>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div id="tab_information" class="tab-pane">
                                <div class="form-group">
                                    <label for="model" class="col-md-2 control-label">مدل *</label>
                                    <div class="col-md-10">
                                        <input id="model" type="text" class="form-control" name="model" value="{{ old('model') }}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="giftcard" class="col-md-2 control-label">کارت هدیه</label>
                                    <div class="col-md-10">
                                        <input type="text" name="giftcard" id="giftcard" class="form-control" placeholder="کارت هدیه" value="{{ old('giftcard') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="بج" class="col-md-2 control-label">بج</label>
                                    <div class="col-md-10">
                                        <input type="text" name="badge" id="badge" class="form-control" placeholder="بج" value="{{ old('badge') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="warranty" class="col-md-2 control-label">گارانتی</label>
                                    <div class="col-md-10">
                                        <input type="text" name="warranty" id="warranty" class="form-control" placeholder="گارانتی" value="{{ old('warranty') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="special" class="col-md-2 control-label">قیمت ویژه</label>
                                    <div class="col-md-10">
                                        <input type="text" id="special_mask" name="special_mask" class="form-control mask" value="{{ old('special_mask') }}">
                                        <input type="hidden" name="special" id="special" class="price" value="{{ old('special') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="colleague_price" class="col-md-2 control-label">قیمت همکار</label>
                                    <div class="col-md-10">
                                        <input type="text" id="colleague_price_mask" name="colleague_price_mask" class="form-control mask" value="{{ old('colleague_price_mask') }}">
                                        <input type="hidden" name="colleague_price" id="colleague_price" class="price" value="{{ old('colleague_price') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="stock" class="col-md-2 control-label">موجودی</label>
                                    <div class="col-md-10">
                                        <input type="number" name="stock" id="stock" class="form-control" value="{{ old('stock') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="suggest" class="col-md-2 control-label">محصولات پیشنهادی</label>
                                    <div class="col-md-10">
                                        <select name="suggest" id="suggest" class="form-control">
                                            <option value="0"{{ (old('suggest') == 0 ? ' selected' : '') }}>نیست</option>
                                            <option value="1"{{ (old('suggest') == 1 ? ' selected' : '') }}>است</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="is_installment" class="col-md-2 control-label">نمایش در صفحه اقساط</label>
                                    <div class="col-md-10">
                                        <select name="is_installment" id="is_installment" class="form-control">
                                            <option value="0"{{ (old('is_installment') == 0 ? ' selected' : '') }}>نمایش داده نشود</option>
                                            <option value="1"{{ (old('is_installment') == 1 ? ' selected' : '') }}>نمایش داده شود</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group hide">
                                    <label for="type" class="col-md-2 control-label">نمایش محصول</label>
                                    <div class="col-md-10">
                                        <select name="type" id="type" class="form-control">
                                            <option value="">نمایش</option>
                                            <option value="visited"{{ (old('type') == "visited" ? ' selected' : '') }}>پربازدیدترین</option>
                                            <option value="new"{{ (old('type') == "new" ? ' selected' : '') }}>جدیدترین</option>
                                         <option value="bestsellers"{{ (old('type') == "bestsellers" ? ' selected' : '') }}>پرفروش ترین</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group hide">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="length" id="length" class="form-control" placeholder="طول محصول" value="{{ old('length') }}">
                                    </div>
                                </div>
                                <div class="form-group hide">
                                    <label for="width" class="col-md-2 control-label">ابعاد (عرض)</label>
                                    <div class="col-md-10">
                                        <input type="text" name="width" id="width" class="form-control" placeholder="عرض محصول" value="{{ old('width') }}">
                                    </div>
                                </div>
                                <div class="form-group hide">
                                    <label for="height" class="col-md-2 control-label">ابعاد (ارتفاع)</label>
                                    <div class="col-md-10">
                                        <input type="text" name="height" id="height" class="form-control" placeholder="ارتفاع محصول" value="{{ old('height') }}">
                                    </div>
                                </div>
                                <div class="form-group hide">
                                    <label for="weight" class="col-md-2 control-label">وزن</label>
                                    <div class="col-md-10">
                                        <input type="number" name="weight" id="weight" class="form-control" placeholder="وزن محصول" value="{{ old('weight') }}">
                                    </div>
                                </div>
                                <div class="form-group hide">
                                    <label for="length_unit" class="col-md-2 control-label">واحد طول</label>
                                    <div class="col-md-10">
                                        <select name="length_unit" id="length_unit" class="form-control">
                                            <option></option>
                                            <option value="metre"{{ (old('length_unit') == 'metre' ? ' selected' : '') }}>متر</option>
                                            <option value="centimetre"{{ (old('length_unit') == 'centimetre' ? ' selected' : '') }}>سانتی متر</option>
                                            <option value="milimetre"{{ (old('length_unit') == 'milimetre' ? ' selected' : '') }}>میلی متر</option>
                                            <option value="inch"{{ (old('length_unit') == 'inch' ? ' selected' : '') }}>اینچ</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group hide">
                                    <label for="weight_unit" class="col-md-2 control-label">واحد وزن</label>
                                    <div class="col-md-10">
                                        <select name="weight_unit" id="weight_unit" class="form-control">
                                            <option></option>
                                            <option value="kilogram"{{ (old('weight_unit') == 'kilogram' ? ' selected' : '') }}>کیلوگرم</option>
                                            <option value="gram"{{ (old('weight_unit') == 'gram' ? ' selected' : '') }}>گرم</option>
                                            <option value="lb"{{ (old('weight_unit') == 'lb' ? ' selected' : '') }}>پوند</option>
                                            <option value="oz"{{ (old('weight_unit') == 'oz' ? ' selected' : '') }}>انس</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="hide_price" class="col-md-2 control-label">مخفی کردن قیمت</label>
                                    <div class="col-md-10">
                                        <select name="hide_price" id="hide_price" class="form-control">
                                            <option value="0"{{ (old('hide_price') == 0 ? ' selected' : '') }}>قیمت نمایش داده شود</option>
                                            <option value="1"{{ (old('hide_price') == 1 ? ' selected' : '') }}>تماس با ما به جای قیمت نمایش داده شود</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="is_foreign" class="col-md-2 control-label">محصول خارجی</label>
                                    <div class="col-md-10">
                                        <select name="is_foreign" id="is_foreign" class="form-control">
                                            <option value="1" {{ old('is_foreign') == '1' ? ' selected' : '' }}>می‌باشد</option>
                                            <option value="0" {{ old('is_foreign') == '0' ? ' selected' : '' }}>نمی‌باشد</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="required_national_id" class="col-md-2 control-label">کدملی</label>
                                    <div class="col-md-10">
                                        <input type="checkbox" name="required_national_id" id="required_national_id" value="1" data-width="100" data-toggle="toggle" data-onstyle="success" data-on="<i class='fa fa-check'></i> اجباری" data-off="<i class='fa fa-close'></i> اختیاری"{{ old('required_national_id') ? ' checked' : '' }}>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="is_festival" class="col-md-2 control-label">وضعیت جشنواره</label>
                                    <div class="col-md-10">
                                        <input type="checkbox" name="is_festival" id="is_festival" value="1" data-width="100" data-toggle="toggle" data-onstyle="success" data-on="<i class='fa fa-check'></i> جشنواره" data-off="<i class='fa fa-close'></i> عادی"{{ old('is_festival') ? ' checked' : '' }}>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="is_available" class="col-md-2 control-label">وضعیت موجودی</label>
                                    <div class="col-md-10">
                                        <input type="checkbox" name="is_available" id="is_available" value="1" data-width="100" data-toggle="toggle" data-onstyle="success" data-on="<i class='fa fa-check'></i> موجود" data-off="<i class='fa fa-close'></i> ناموجود" checked>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab_links">
                                <div class="form-group">
                                    <label for="manufacturer_id" class="col-md-2 control-label">تولیدکننده *</label>
                                ...
                                <div class="form-group">
                                    <label for="categories" class="col-md-2 control-label">انتخاب دسته‌بندی‌ها</label>
                                    <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    <label for="products" class="col-md-2 control-label">انتخاب محصولات مرتبط</label>
                                    <div class="col-md-10">
                                        <select name="product_id[]" id="products" class="form-control" multiple="multiple">
                                            @foreach($products as $key => $product)
                                                <option value="{{ $key }}"{{ (in_array($key, old('product_id') ?? []) ? ' selected' : '') }}>{{ $product }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="cross_products" class="col-md-2 control-label">انتخاب محصولات مکمل</label>
                                    <div class="col-md-10">
                                        <select name="cross_product_id[]" id="cross_products" class="form-control" multiple="multiple">
                                            @foreach($products as $key => $product)
                                                <option value="{{ $key }}"{{ (in_array($key, old('cross_product_id') ?? []) ? ' selected' : '') }}>{{ $product }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="filter_id" class="col-md-2 control-label">انتخاب فیلترها</label>
                                    <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    <label for="warranty_id" class="col-md-2 control-label">انتخاب گارانتی‌ها</label>
                                    <div class="col-md-10">
                                        <select name="warranty_id[]" id="warranties" class="form-control" multiple="multiple">
                                            @foreach($warranties as $warrantyId => $warranty)
                                                <option value="{{ $warrantyId }}"{{ (in_array($key, old('warranty_id') ?? []) ? ' selected' : '') }}>{{ $warranty }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="tab_images">
                                <div class="form-group">
                                    <label for="image" class="col-md-2 control-label">تصویر اصلی</label>
                                    <div class="col-md-4">
                            ...
                            <div class="tab-pane" id="tab_catalogue">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input id="catalogue_name" type="text" class="form-control" name="catalogue_name" value="{{ old('catalogue_name') }}" placeholder="عنوان کاتالوگ را وارد کنید" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                      <label for="catalogue" class="col-md-2 control-label">کاتالوگ</label>
                                    <div class="col-md-10">
                        ...
                        <!-- /.tab-content -->
                        <input type="submit" class="btn btn-primary" value="افزودن محصول">
                    </form>
                </div>
            </div>
            <!-- /.box-body -->
