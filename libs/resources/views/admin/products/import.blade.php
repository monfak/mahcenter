    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">افزودن گروهی محصول</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form method="POST" action="{{ route('admin.products.import.excel') }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                    @csrf
