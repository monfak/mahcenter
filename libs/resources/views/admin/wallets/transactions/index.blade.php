    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                    <div class="input-group input-group-sm">
                        <a href="{{ route('admin.payment-methods.create') }}" class="btn btn-default btn-sm">
                            <span class="fa fa-plus"></span> افزودن روش پرداخت
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="box-body table-responsive no-padding">
                <table id="payment-methods" class="table table-hover">
                    <thead>
                        <tr>
                            <th>نام</th>
                            <th>نوع</th>
