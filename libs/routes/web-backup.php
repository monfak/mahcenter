...
use App\Http\Controllers\Frontend\B2bController;
...
Route::get('b2b', [B2bController::class, 'index'])->name('b2b.index');
...
Route::name('frontend.')->group(function () {
    ...
    Route::post('details/get-shipping-cost', [DetailController::class, 'getShippingCost'])->name('details.get-shipping-cost');
...
Route::post('cart/add-normal/{id}', [CartController::class, 'addNormal'])->name('cart.add-normal');
