...
if (class_exists("ParsVT_Loader")) {
    ParsVT_Loader::ParsAutoload('DateTimeField');
}
...
/**PVTPATCHER-3211EF045F5C687CC026EBB8C1322587-START-dateformat73**/
...
/**PVTPATCHER-3211EF045F5C687CC026EBB8C1322587-FINISH**/
		if (!$y && !$m && !$d) {
			$dbDate = '';
		} else {
			$dbDate = $y . '-' . $m . '-' . $d;
...
/**PVTPATCHER-943B809454B8CB810644C66205DA63D3-START-dateformat73**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:34:05 **/
elseif ($format == 'dd/mm/yyyy') {
            $date[0] = $d . '/' . $m . '/' . $y;
        } elseif ($format == 'mm/dd/yyyy') {
...
/**PVTPATCHER-943B809454B8CB810644C66205DA63D3-FINISH**/
		if ($date[1] != '') {
...
/**PVTPATCHER-FA9FECC0D39DE07852DB1DE5B8238F74-START-dateformat73**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:34:05 **/
...
/**PVTPATCHER-FA9FECC0D39DE07852DB1DE5B8238F74-FINISH**/
