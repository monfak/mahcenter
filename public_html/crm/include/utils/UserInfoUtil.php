...
{
	global $log;
/**PVTPATCHER-EB72C9DC4EC1CC12AB25833DA935D003-START-sharingaccess**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:36:02 **/
if (class_exists('ParsVT_PrivilegeFiles_Model') && method_exists('ParsVT_PrivilegeFiles_Model', 'fetchUserRole')) return ParsVT_PrivilegeFiles_Model::fetchUserRole($userid);
/**PVTPATCHER-EB72C9DC4EC1CC12AB25833DA935D003-FINISH**/
...
$log->debug("Entering getProfileGlobalPermission(".$profileid.") method ...");
  global $adb;
/**PVTPATCHER-7D07190829A04DF25871093FDD82C2B9-START-sharingaccess**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:36:02 **/
$copy = array();
/**PVTPATCHER-7D07190829A04DF25871093FDD82C2B9-FINISH**/
...
{
global $log;
/**PVTPATCHER-83BA0EEF0C6418BB7AD5738BA0E65BE7-START-sharingaccess**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:36:02 **/
if (class_exists('ParsVT_PrivilegeFiles_Model') && method_exists('ParsVT_PrivilegeFiles_Model', 'getProfileTabsPermission')) return ParsVT_PrivilegeFiles_Model::getProfileTabsPermission($profileid);
/**PVTPATCHER-83BA0EEF0C6418BB7AD5738BA0E65BE7-FINISH**/
...
{
	global $log;
/**PVTPATCHER-A13426FF574D4F7F09F1208B230421AD-START-sharingaccess**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:36:02 **/
if (class_exists('ParsVT_PrivilegeFiles_Model') && method_exists('ParsVT_PrivilegeFiles_Model', 'getRoleInformation')) return ParsVT_PrivilegeFiles_Model::getRoleInformation($roleid);
/**PVTPATCHER-A13426FF574D4F7F09F1208B230421AD-FINISH**/
...
{
	global $log;
/**PVTPATCHER-EC9B4AE491F3C890E9B7AC88C8747925-START-sharingaccess**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:36:02 **/
if (class_exists('ParsVT_PrivilegeFiles_Model') && method_exists('ParsVT_PrivilegeFiles_Model', 'RecalculateSharingRules')) return ParsVT_PrivilegeFiles_Model::RecalculateSharingRules();
/**PVTPATCHER-EC9B4AE491F3C890E9B7AC88C8747925-FINISH**/
