...
/**PVTPATCHER-3FF579A56FBF11655499059D4E108AA9-START-ws**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:38 **/
if (method_exists('ParsVT_CustomFunctions_Helper', 'ParsVTUpdateProductsInventoryRel')) ParsVT_CustomFunctions_Helper::ParsVTUpdateProductsInventoryRel($product_id, 'qtyinstock', $upd_qty);
/**PVTPATCHER-3FF579A56FBF11655499059D4E108AA9-FINISH**/
	global $adb;
...
/**PVTPATCHER-BF7C1C9F5944B4AB293845A22F9E4C8E-START-ws**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:38 **/
if (method_exists('ParsVT_CustomFunctions_Helper', 'ParsVTUpdateProductsInventoryRel')) ParsVT_CustomFunctions_Helper::ParsVTUpdateProductsInventoryRel($productId, 'qtyinstock', $updQty, $qtyInStck);
/**PVTPATCHER-BF7C1C9F5944B4AB293845A22F9E4C8E-FINISH**/
...
/**PVTPATCHER-0B6BE21E1172CD822B700F1DD40AA5CC-START-ws**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:38 **/
if (method_exists('ParsVT_CustomFunctions_Helper', 'ParsVTUpdateProductsInventoryRel')) ParsVT_CustomFunctions_Helper::ParsVTUpdateProductsInventoryRel($productId, 'qtyindemand', $updQty, $qtyInStck);
/**PVTPATCHER-0B6BE21E1172CD822B700F1DD40AA5CC-FINISH**/
...
/**PVTPATCHER-80B34E89D032F469AA2E2F57317E294A-START-ws**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:38 **/
if (method_exists('ParsVT_CustomFunctions_Helper', 'ParsVTUpdateProductsInventoryRel')) ParsVT_CustomFunctions_Helper::ParsVTUpdateProductsInventoryRel($productId, 'qtyinstock', $updQty, $qty);
/**PVTPATCHER-80B34E89D032F469AA2E2F57317E294A-FINISH**/
...
/**PVTPATCHER-57A17EB36D7DFBF5E74709ECC57F5D39-START-ws**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:38 **/
if (method_exists('ParsVT_CustomFunctions_Helper', 'ParsVTUpdateProductsInventoryRel')) ParsVT_CustomFunctions_Helper::ParsVTUpdateProductsInventoryRel($productId, 'qtyindemand', $updQty, $qty);
/**PVTPATCHER-57A17EB36D7DFBF5E74709ECC57F5D39-FINISH**/
...
/**PVTPATCHER-FE77E20A9627F0A47FEB70C71521D643-START-advcf**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:23 **/
if (class_exists('ParsVT_Constant_Model') && method_exists('ParsVT_Constant_Model', 'calculateRelatedRollup')) {
            ParsVT_Constant_Model::calculateRelatedRollup($return_id, $module);
        }
/**PVTPATCHER-FE77E20A9627F0A47FEB70C71521D643-FINISH**/
	} else {
...
/**PVTPATCHER-16F34196B34C5555EDC21B31A4811A19-START-advcf**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:23 **/
if (class_exists('ParsVT_Constant_Model') && method_exists('ParsVT_Constant_Model', 'calculateRelatedRollup')) {
            ParsVT_Constant_Model::calculateRelatedRollup($sourceRecordId, $destinationModule);
        }
/**PVTPATCHER-16F34196B34C5555EDC21B31A4811A19-FINISH**/
	}
...
/** Function to set date values compatible to database (YY_MM_DD)
  ...
  */
/**PVTPATCHER-F23DE86BA7B731002F0222278A3C11B4-START-utils**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:33:37 **/
if (class_exists("ParsVT_Loader")) ParsVT_Loader::ParsFuncAutoload('utils');
            if (!function_exists("getValidDBInsertDateValue")) {
/**PVTPATCHER-F23DE86BA7B731002F0222278A3C11B4-FINISH**/
...
/**PVTPATCHER-75E623A223082333369530EA72649D63-START-utils**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:33:37 **/
}
/**PVTPATCHER-75E623A223082333369530EA72649D63-FINISH**/
...
/**PVTPATCHER-D73823469AD58AEDB6124A915F78F06F-START-chars**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:29:42 **/
if (method_exists("ParsVT_Module_Model", "fixPersianChars")) {
                $newFileName = ParsVT_Module_Model::fixPersianChars($newFileName);
            }
/**PVTPATCHER-D73823469AD58AEDB6124A915F78F06F-FINISH**/
	return $newFileName;
		}
