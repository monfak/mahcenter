					...
					<div>
						<div style="margin-left: 20px;">
							{foreach item="FIELD_MODEL" from=$RECORD_STRUCTURE['LBL_CALENDAR_SETTINGS']}
								...
								{/if}
								{**PVTPATCHER-386C788782F4AB079613C5041F406545-START-cal**}
{** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:33:36 **}
{if $FIELD_NAME neq 'callduration' && $FIELD_NAME neq 'othereventduration' && $FIELD_NAME neq 'defaulteventstatus' && $FIELD_NAME neq 'defaultactivitytype' && $FIELD_NAME neq 'hidecompletedevents' && $FIELD_NAME neq 'parsvt_ircal' && $FIELD_NAME neq 'parsvt_salah'}
{** REPLACED-386C788782F4AB079613C5041F406545// {if $FIELD_NAME neq 'callduration' && $FIELD_NAME neq 'othereventduration' && $FIELD_NAME neq 'defaulteventstatus' && $FIELD_NAME neq 'defaultactivitytype' && $FIELD_NAME neq 'hidecompletedevents'}**}
{**PVTPATCHER-386C788782F4AB079613C5041F406545-FINISH**}
