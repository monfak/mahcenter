...
/** @class ParsGuard_License_Js */
jQuery.Class('ParsGuard_License_Js', {}, {
...
jQuery(document).ready(function(){
	var ParsGuardLicenseInstance = new ParsGuard_License_Js();
	ParsGuardLicenseInstance.registerEvents();
})