            ...
            <div class="filePreview container-fluid">
                <div class="modal-header row">
                    <div class="filename col-lg-8">
                        <h3 style="margin-top:0px;" alt="{$FILE_NAME}" title="{$FILE_NAME}" style="direction: ltr"><b>{$FILE_NAME2}</b></h3>
                    </div>
                    <div class="col-lg-3">
                    ...
                    {else}
                        ...
                        {else if $VIDEO_FILE_TYPE eq 'yes'}
                            <div style="overflow:auto;height:100%;">
                                ...
                                <video class="video-js vjs-default-skin" controls preload="auto" {literal}data-setup="{'techOrder': ['flash', 'html5']}" {/literal}width="100%" height="100%" style="width: 100%; height: auto;">
                                    <source src="{$SITE_URL}/{$DOWNLOAD_URL}" type='{$FILE_TYPE}' />
                                </video>
                            </div>
                        {/if}
