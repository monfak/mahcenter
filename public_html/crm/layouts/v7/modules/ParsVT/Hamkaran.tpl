<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:0px;">
    <h4>{vtranslate('Hamkaran Settings', $QUALIFIED_MODULE)}</h4>
    <hr>
</div>
...
<div class="col-lg-12" style="margin-top: 10px">
    ...
    {if $PBXMANAGER}
        ...
        <form id="AsteriskCTIForm" class="form-horizontal" action='index.php' method='POST'>
            ...
            <input type="hidden" name="mode" value="Hamkaran"/>
            ...
            <div class="blockData">
                <table class="table table-bordered blockContainer showInlineTable equalSplit">
                    <thead>
                    <tr class="active">
                        <th class="" colspan="4"<img src="layouts/{vglobal('default_layout')}/modules/ParsVT/images/helpinfo.png"> &nbsp;{vtranslate('Hamkaran Configration', $MODULE)}</th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <tr>
                        ...
                        <td class="row-fluid medium">
                            <input class="inputElement fieldValue"
                                   ...
                                   value="{vglobal('site_URL')}modules/ParsVT/ws/API/V2/PBX/Hamkaran/CDR/{$VTIGERSECRETKEY}" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td class="fieldLabel control-label"
                            style="width:25%">{vtranslate('CID Lookup URL',$QUALIFIED_MODULE)}</td>
                        <td class="row-fluid medium">
                            <input class="inputElement fieldValue"
                                   style="direction: ltr; text-align: left;" type="text"
                                   value="{vglobal('site_URL')}modules/ParsVT/ws/API/V2/PBX/Hamkaran/SearchPBX/{$VTIGERSECRETKEY}?phone=[NUMBER]&format=1" readonly>
                        </td>
                    </tr>
