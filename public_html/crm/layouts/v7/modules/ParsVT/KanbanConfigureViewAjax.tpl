...
<style>
    ...
    {assign var=ParsVTMODULE value='ParsVT'}
        ...
        <form class="form-horizontal" id="KanbanConfigure" name="KanbanConfigure" method="post" action="index.php">
            ...
            <div class="modal-header">
                <div class="clearfix">
                    ...
                    <h4 class="pull-left">{vtranslate('LBL_CONFIGURE_KANBAN_VIEW','ParsVT')}</h4>
                </div>
            </div>
            <div class="modal-body" >
                <div class="col-sm-12 col-xs-12 input-group" style="display: none">
                    <div class="form-group">
                        <label class="col-sm-4 control-label fieldLabel">
                            <strong>{vtranslate('LBL_DEFAULT_PAGE','ParsVT')}</strong>
                        </label>
                ...
                <div class="col-sm-12 col-xs-12 input-group">
                    <div class="form-group">
                        <label class="col-sm-4 control-label fieldLabel">
                            <strong>{vtranslate('LBL_PRIMARY_FIELD','ParsVT')}</strong>
                            <span class="redColor">*</span>
                        </label>
                        <div class="fieldValue col-lg-3 col-md-3 col-sm-3 input-group">
                            <select class="select2" name="primaryField" data-rule-required="true">
                                {foreach item=PRIMARY_NAME from=$PRIMARY_FIELDS}
                                    <option value="{$PRIMARY_NAME['fieldid']}" {if $PRIMARY_NAME['fieldid'] eq  $PRIMARY_SETTING['primary_field']} selected {/if}>{vtranslate($PRIMARY_NAME['fieldlabel'],$smarty.request.source_module)}</option>
                                {/foreach}
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-xs-12">
                    <h4 class="textAlignCenter">{vtranslate('LBL_CONFIGURE_TILE_FIELDS','ParsVT')}</h4>
                </div>
                    ...
                    <div class="form-group">
                        <table class="table table-container listOtherField" style="table-layout: fixed;">
                            ...
                            {if $PRIMARY_SETTING['other_field']}
                                {foreach item = OTHER_FIELD from=$PRIMARY_SETTING['other_field'] }
                                    <tr class="otherField">
                                        ...
                                        <td >{include file="KanbanFieldSelect.tpl"|@vtemplate_path:$ParsVTMODULE MULTIPLE = 0 }</td>
                                        <td>
                            ...
                            {else}
                                <tr class="otherField">
                                    ...
                                    <td >{include file="KanbanFieldSelect.tpl"|@vtemplate_path:$ParsVTMODULE MULTIPLE = 0 OTHER_FIELD = array() }</td>
                                    <td>
                                        <span class="otherFieldAction" style="line-height: 30px">
                                            <i title="Delete"  class="fa fa-trash alignMiddle deleteOtherField" style="cursor: pointer"></i>
                                        </span>
                        ...
                        <table class="hide fieldBasic">
                            <tr class="otherField">
                                ...
                                <td>{include file="KanbanFieldSelect.tpl"|@vtemplate_path:$ParsVTMODULE MULTIPLE = 0 NOCHOSEN=true OTHER_FIELD = array() }</td>
                                <td>
                                    <span class="otherFieldAction" style="line-height: 30px">
                                        <i title="Delete"  class="fa fa-trash alignMiddle deleteOtherField" style="cursor: pointer"></i>
                                    </span>
                        ...
                        <div class="col-sm-12 col-xs-12" >
                            <div class="form-group">
                                <span class="btn addButton btn-default btnAddMore">{vtranslate('LBL_CLICK_HERE_TO_ADD_MORE','ParsVT')}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id="save_kanbanview_setting" type="button"><strong>{vtranslate('LBL_SAVE', 'ParsVT')}</strong></button>
            </div>
        </form>
    </div>
</div>
