...
{strip}
	...
	<html>
		<head>
			...
			<link type="text/css" rel="stylesheet" href="modules/ParsVT/resources/styles/rtl.php?v=7.0.1" media="screen" />
		...
		<body style="background-color: #fff;"  data-calendar="{$CALENDAR}">
			<style>
				.resEdit {
					padding: 15px;
				}
			...
			<br>
			<div class="row">
				<div class="pull-right noprint" style="margin:0 50px;">
			...
			<script type="text/javascript" src="layouts/{vglobal('default_layout')}/modules/ParsVT/resources/GC/GCB.js"></script>
		</body>
	</html>
{/strip}