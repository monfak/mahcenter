<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:0px;">
    <h4>{vtranslate('TelC Settings', $QUALIFIED_MODULE)}</h4>
    <hr>
</div>
...
{assign var=CURRENT_USER_MODEL value=Users_Record_Model::getCurrentUserModel()}
    ...
    {if $PBXMANAGER}
        ...
        <form id="AsteriskCTIForm" class="form-horizontal" action='index.php' method='POST'>
            ...
            <input type="hidden" name="mode" value="TelC"/>
            ...
            <div class="blockData">
                <table class="table table-bordered blockContainer showInlineTable equalSplit">
                    <thead>
                        <tr class="active">
                            <th class="" colspan="4"<img src="layouts/{vglobal('default_layout')}/modules/ParsVT/images/helpinfo.png"> &nbsp;{vtranslate('TelC Configration', $MODULE)}</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="row-fluid medium">
                                <input class="inputElement fieldValue"
                                       ...
                                       value="{vglobal('site_URL')}modules/ParsVT/ws/API/V2/PBX/TelC/CDR/{$VTIGERSECRETKEY}/" readonly>
                            </td>
                        </tr>
