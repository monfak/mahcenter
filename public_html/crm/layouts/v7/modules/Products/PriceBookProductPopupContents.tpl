                ...
                {if $LISTVIEW_ENTRIES_COUNT eq '0'}
                    <div class="row">
                        <div class="emptyRecordsDiv">
                            {**PVTPATCHER-08AC7EAB7BD36697262C54789CB4F64F-START-theme730**}
...
{assign var=CURRENT_USER_MODEL value=Users_Record_Model::getCurrentUserModel()}
								...
								{/if}
{** REPLACED-08AC7EAB7BD36697262C54789CB4F64F// {vtranslate('LBL_NO', $MODULE_NAME)} {vtranslate($MODULE_NAME, $MODULE_NAME)} {vtranslate('LBL_FOUND', $MODULE_NAME)}.**}
{**PVTPATCHER-08AC7EAB7BD36697262C54789CB4F64F-FINISH**}
                        </div>
                    </div>
                {/if}
            </div>
