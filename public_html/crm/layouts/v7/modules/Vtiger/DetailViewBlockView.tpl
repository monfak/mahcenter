						...
						<tr>
							{foreach item=FIELD_MODEL key=FIELD_NAME from=$FIELD_MODEL_LIST}
								...
								{else if $FIELD_MODEL->get('uitype') eq "69" || $FIELD_MODEL->get('uitype') eq "105"}
									...
									{assign var=COUNTER value=$COUNTER+1}
								{else}
									{**PVTPATCHER-1B13F7A301AA3F69D65310AE96D90DDB-START-customfields**}
{** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:23 **}
{if $FIELD_MODEL->get('uitype') eq "20" or $FIELD_MODEL->get('uitype') eq "19" or $FIELD_MODEL->get('uitype') eq "35" or $fieldDataType eq 'reminder' or $fieldDataType eq 'recurrence'}
{** REPLACED-1B13F7A301AA3F69D65310AE96D90DDB// {if $FIELD_MODEL->get('uitype') eq "20" or $FIELD_MODEL->get('uitype') eq "19" or $fieldDataType eq 'reminder' or $fieldDataType eq 'recurrence'}**}
{**PVTPATCHER-1B13F7A301AA3F69D65310AE96D90DDB-FINISH**}
										{if $COUNTER eq '1'}
									...
									<td class="fieldValue {$WIDTHTYPE}" id="{$MODULE_NAME}_detailView_fieldValue_{$FIELD_MODEL->getName()}" {**PVTPATCHER-D48CC48C9C872124A53B0954ED6D3182-START-customfields**}
{** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:23 **}
{if $FIELD_MODEL->get('uitype') eq '19' or $FIELD_MODEL->get('uitype') eq '35' or $fieldDataType eq 'reminder' or $fieldDataType eq 'recurrence'}
{** REPLACED-D48CC48C9C872124A53B0954ED6D3182// {if $FIELD_MODEL->get('uitype') eq '19' or $fieldDataType eq 'reminder' or $fieldDataType eq 'recurrence'}**}
{**PVTPATCHER-D48CC48C9C872124A53B0954ED6D3182-FINISH**} colspan="3" {assign var=COUNTER value=$COUNTER+1} {/if}>
								...
								{**PVTPATCHER-EC66B9CA818488B41AA6DA55AB951028-START-customfields**}
{** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:23 **}
{if $FIELD_MODEL_LIST|@count eq 1 and $FIELD_MODEL->get('uitype') neq "19" and $FIELD_MODEL->get('uitype') neq "35" and $FIELD_MODEL->get('uitype') neq "20" and $FIELD_MODEL->get('uitype') neq "30" and $FIELD_MODEL->get('name') neq "recurringtype" and $FIELD_MODEL->get('uitype') neq "69" and $FIELD_MODEL->get('uitype') neq "105"}
{** REPLACED-EC66B9CA818488B41AA6DA55AB951028// {if $FIELD_MODEL_LIST|@count eq 1 and $FIELD_MODEL->get('uitype') neq "19" and $FIELD_MODEL->get('uitype') neq "20" and $FIELD_MODEL->get('uitype') neq "30" and $FIELD_MODEL->get('name') neq "recurringtype" and $FIELD_MODEL->get('uitype') neq "69" and $FIELD_MODEL->get('uitype') neq "105"}**}
{**PVTPATCHER-EC66B9CA818488B41AA6DA55AB951028-FINISH**}
