	...
	<head>
		...
		<script type="text/javascript">
            ...
            {if $CURRENT_USER_MODEL}
               {**PVTPATCHER-96147699FC8EFDCD0605DE4C9D9B1F58-START-theme730**}
{** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:29:26 **}
_USERMETA =  { 'id' : "{$CURRENT_USER_MODEL->get('id')}", 'menustatus' : "{$CURRENT_USER_MODEL->get('leftpanelhide')}",  'admin' :"{$CURRENT_USER_MODEL->get('is_admin')}",
{** REPLACED-96147699FC8EFDCD0605DE4C9D9B1F58// _USERMETA =  { 'id' : "{$CURRENT_USER_MODEL->get('id')}", 'menustatus' : "{$CURRENT_USER_MODEL->get('leftpanelhide')}",**}
{**PVTPATCHER-96147699FC8EFDCD0605DE4C9D9B1F58-FINISH**} 
	...
	<body data-skinpath="{Vtiger_Theme::getBaseThemePath()}" data-calendar="{if $CURRENT_USER_MODEL->get('parsvt_calendar')}{$CURRENT_USER_MODEL->get('parsvt_calendar')}{else}gregorian{/if}" data-language="{$LANGUAGE}"" data-desktop="{if $CURRENT_USER_MODEL->get('parsvt_desktop')}{$CURRENT_USER_MODEL->get('parsvt_desktop')}{else}0{/if}" data-user-decimalseparator="{$CURRENT_USER_MODEL->get('currency_decimal_separator')}" data-user-dateformat="{$CURRENT_USER_MODEL->get('date_format')}"
