                        ...
                        <table class="massEditTable table no-border">
                            <tr>
                                ...
                                {foreach key=FIELD_NAME item=FIELD_MODEL from=$RECORD_STRUCTURE name=blockfields}
                                    ...
                                    {**PVTPATCHER-D9EF6804EAEB14657588339716890791-START-customfields**}
...
{** REPLACED-D9EF6804EAEB14657588339716890791// {if $FIELD_MODEL->get('uitype') eq "19"}**}
{**PVTPATCHER-D9EF6804EAEB14657588339716890791-FINISH**}
                                        {if $COUNTER eq '1'}
                                            <td></td><td></td></tr><tr>
                                            {assign var=COUNTER value=0}
                                        {/if}
                                    ...
                                    {if $FIELD_MODEL->get('uitype') neq '83'}
                                        <td class="fieldValue col-lg-4" {**PVTPATCHER-62DF85B8CF1E1233ED614F823DC6C488-START-customfields**}
{** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:23 **}
{if $FIELD_MODEL->get('uitype') eq '19' or $FIELD_MODEL->get('uitype') eq '35'}
{** REPLACED-62DF85B8CF1E1233ED614F823DC6C488// {if $FIELD_MODEL->get('uitype') eq '19'}**}
{**PVTPATCHER-62DF85B8CF1E1233ED614F823DC6C488-FINISH**} colspan="3" {assign var=COUNTER value=$COUNTER+1} {/if}>
