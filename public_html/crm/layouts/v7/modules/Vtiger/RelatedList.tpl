						...
						<tr class="listViewEntries" data-id='{$RELATED_RECORD->getId()}' 
							...
							{foreach item=HEADER_FIELD from=$RELATED_HEADERS}
								...
								<td class="relatedListEntryValues" title="{strip_tags($RELATED_RECORD->getDisplayValue($RELATED_HEADERNAME))}" data-field-type="{$HEADER_FIELD->getFieldDataType()}" nowrap>
									{**PVTPATCHER-5F205EF7FB907AB033E07412FA177961-START-customfields**}
{** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:23 **}
<span class="value textOverflowEllipsis {$HEADER_FIELD->get('column')}" data-fieldname="{$HEADER_FIELD->get('column')}">
{** REPLACED-5F205EF7FB907AB033E07412FA177961// <span class="value textOverflowEllipsis">**}
{**PVTPATCHER-5F205EF7FB907AB033E07412FA177961-FINISH**}
