						...
						<tr>
							...
							{foreach key=FIELD_NAME item=FIELD_MODEL from=$BLOCK_FIELDS name=blockfields}
								...
								{if $FIELD_MODEL->isEditable() eq true}
									{**PVTPATCHER-C58B107DF45D77D7C8DB0F7706C3D49E-START-customfields**}
{** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:23 **}
{if $FIELD_MODEL->get('uitype') eq '19' or $FIELD_MODEL->get('uitype') eq '35'}
{** REPLACED-C58B107DF45D77D7C8DB0F7706C3D49E// {if $FIELD_MODEL->get('uitype') eq '19'}**}
{**PVTPATCHER-C58B107DF45D77D7C8DB0F7706C3D49E-FINISH**}
										{if $COUNTER eq '1'}
											<td></td><td></td></tr><tr>
											{assign var=COUNTER value=0}
										{/if}
									...
									{if $FIELD_MODEL->get('uitype') neq '83'}
										<td {**PVTPATCHER-22BF3D6B112070FF54D8B46802992EFE-START-customfields**}
{** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:23 **}
{if in_array($FIELD_MODEL->get('uitype'),array('19','69','35')) || $FIELD_NAME eq 'description' ||  (($FIELD_NAME eq 'recurringtype' or $FIELD_NAME eq 'reminder_time')  && in_array({$MODULE},array('Events','Calendar')))}
{** REPLACED-22BF3D6B112070FF54D8B46802992EFE// {if in_array($FIELD_MODEL->get('uitype'),array('19','69')) || $FIELD_NAME eq 'description' ||  (($FIELD_NAME eq 'recurringtype' or $FIELD_NAME eq 'reminder_time')  && in_array({$MODULE},array('Events','Calendar')))}**}
{**PVTPATCHER-22BF3D6B112070FF54D8B46802992EFE-FINISH**} class="fieldValue fieldValueWidth80"  colspan="3" {assign var=COUNTER value=$COUNTER+1} {elseif $FIELD_MODEL->get('uitype') eq '56'} class="fieldValue checkBoxType" {elseif $isReferenceField eq 'reference' or $isReferenceField eq 'multireference' } class="fieldValue p-t-8" {else}class="fieldValue" {/if}>
