                    ...
                    <div class="list-menu-content">
                        <ul class="lists-menu"> 
                            {foreach from=$EXTENSION_LINKS item=LINK}
                                {**PVTPATCHER-47AB2513AD61AC3984B443910372AC79-START-customfields**}
{** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:23 **}
{if $LINK->isExtensionAccessible() or $LINK->get('handler_class') == 'ParsVTCustomLinks' or $LINK->get('linklabel') eq 'View Map'  or $LINK->get('linklabel') eq 'Grid View'  or $LINK->get('linklabel') eq 'Kanban View'}
{** REPLACED-47AB2513AD61AC3984B443910372AC79// {if $LINK->isExtensionAccessible()}**}
{**PVTPATCHER-47AB2513AD61AC3984B443910372AC79-FINISH**}
