...
/**PVTPATCHER-CCCED22A3E617E1A25FF7EAEAC32A21D-START-dateformat73**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:34:05 **/
...
/**PVTPATCHER-CFE7C1789E54B61957FB3D87DB12D3C1-START-dateformat73**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:34:05 **/
...
/**PVTPATCHER-8C745530CBFE62CB55CB404654D4E154-START-utils**/
...
try {
                        ...
                        if (ParsCalenderType === 'islamic' || ParsCalenderType === 'jalali') {
                            var splitDateFormat = dateObject.split('-');
                            for (var key in splitDateFormat) {
                                if (splitDateFormat[key].length != 4) {
                                    splitDateFormat[key] = ('0' + splitDateFormat[key]).slice(-2);
                                }
                            }
                            var date = splitDateFormat.join('-');
                        }
                    }
/** REPLACED-8C745530CBFE62CB55CB404654D4E154// var date = jQuery.datepicker.formatDate(finalFormat, dateObject);**/
/**PVTPATCHER-8C745530CBFE62CB55CB404654D4E154-FINISH**/
			return date;
		},
