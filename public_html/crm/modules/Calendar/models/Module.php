...
/**PVTPATCHER-B01262DF2AA42DFFD080964D3E3900E7-START-ircal**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:33:54 **/
$calendarViewTypes = ParsVT_DisplayFields_Model::calendarViewTypes($calendarViewTypes);
/**PVTPATCHER-B01262DF2AA42DFFD080964D3E3900E7-FINISH**/
	...
	public static function getCalendarReminder() {
		...
		if($activityReminder != '' ) {
			...
			$reminderActivitiesResult = "SELECT reminderid, recordid FROM vtiger_activity_reminder_popup
								...
								AND (vtiger_crmentity.smownerid = ? or  vtiger_crmentity.smownerid IN (select groupid from vtiger_users2group where userid = ".$currentUserModel->getId().")) AND vtiger_crmentity.deleted = 0
