	...
	function checkPermission(Vtiger_Request $request) {
		...
		if(!$recordPermission) {
			...
			if ($httpReferer) {
				...
				parse_str($query , $outputresult);
			}
			if (isset($outputresult['view'],$outputresult['module']) && $outputresult['view'] == 'Edit') {
				header("Location: index.php?module=".$outputresult['module']."&view=List"); exit;
			} else {
