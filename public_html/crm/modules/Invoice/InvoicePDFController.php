...
class Vtiger_InvoicePDFController extends Vtiger_InventoryPDFController{
	...
	function buildHeaderModelColumnRight() {
		...
		$modelColumnRight = array(
				'dates' => array(
/**PVTPATCHER-9B41B99CB68329F0D6F1E0AF217AC1C2-START-pdf**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:17 **/
$issueDateLabel  => $this->formatDate(date("Y-m-d", strtotime($this->focusColumnValue('invoicedate')))),
/** REPLACED-9B41B99CB68329F0D6F1E0AF217AC1C2// $issueDateLabel  => $this->formatDate(date("Y-m-d")),**/
/**PVTPATCHER-9B41B99CB68329F0D6F1E0AF217AC1C2-FINISH**/
