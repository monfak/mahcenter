...
function sendmail($to,$from,$subject,$contents,$mail_server,$mail_server_username,$mail_server_password,$filename,$smtp_auth='')
{
  ...
  $mail->Subject = $subject;
	...
	if (method_exists('Vtiger_Functions','fromProtectedText')) {
		$mail->Password = Vtiger_Functions::isProtectedText($mail_server_password) ? Vtiger_Functions::fromProtectedText($mail_server_password) : $mail_server_password; // SMTP password
	} else {
