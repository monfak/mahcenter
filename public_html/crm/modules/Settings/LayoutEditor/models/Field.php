...
/**PVTPATCHER-7BC42BFA016CC43DBB0A726A767775CC-START-advcf**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:23 **/
$query = "SELECT * FROM vtiger_field WHERE columnname = ?";
            $result = $adb->pquery($query, array($columnname));
            if ($adb->num_rows($result) > 1) {
                return true;
            }
/**PVTPATCHER-7BC42BFA016CC43DBB0A726A767775CC-FINISH**/
