...
class Settings_Profiles_Record_Model extends Settings_Vtiger_Record_Model {
	...
	public function isModuleFieldLocked($module, $field) {
		$fieldModel = $this->getProfileTabFieldModel($module, $field);
/**PVTPATCHER-F7335C273138AE05FB7CA5EEF6B12EDF-START-advcf**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:30:23 **/
if((!$fieldModel->isEditable() && strpos($fieldModel->getName(), 'cf_pcf_ruf_') === false  && strpos($fieldModel->getName(), 'cf_pcf_aff_') === false  && strpos($fieldModel->getName(), 'cf_pcf_anf_') === false  && strpos($fieldModel->getName(), 'cf_pcf_vsf_') === false )   || $fieldModel->isMandatory()
/** REPLACED-F7335C273138AE05FB7CA5EEF6B12EDF// if(!$fieldModel->isEditable() || $fieldModel->isMandatory()**/
/**PVTPATCHER-F7335C273138AE05FB7CA5EEF6B12EDF-FINISH**/
