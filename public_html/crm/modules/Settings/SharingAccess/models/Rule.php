...
/**PVTPATCHER-D959DA2D855D2B207D3C48A9FEE4FF6A-START-sharingaccess**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:36:02 **/
$db->pquery($sql, $params);
        if (class_exists('ParsVT_PrivilegeFiles_Model') && method_exists('ParsVT_PrivilegeFiles_Model', 'scheduleRecalculateSharingAccess')) {
            ParsVT_PrivilegeFiles_Model::scheduleRecalculateSharingAccess(true);
          } else {
            Settings_SharingAccess_Module_Model::recalculateSharingRules();
          }
          return false;
/**PVTPATCHER-D959DA2D855D2B207D3C48A9FEE4FF6A-FINISH**/
		$db->pquery($sql, $params);
        Settings_SharingAccess_Module_Model::recalculateSharingRules();
	}
...
/**PVTPATCHER-53D50459C0CFC002A6BC0D72C511309A-START-sharingaccess**/
/** Don't remove the Start and Finish Markup! Modified: 2025-01-09 09:36:02 **/
if (class_exists('ParsVT_PrivilegeFiles_Model') && method_exists('ParsVT_PrivilegeFiles_Model', 'scheduleRecalculateSharingAccess')) {
                      	ParsVT_PrivilegeFiles_Model::scheduleRecalculateSharingAccess(true);
                      } else {
                      ...
                      return false;
/**PVTPATCHER-53D50459C0CFC002A6BC0D72C511309A-FINISH**/
        Settings_SharingAccess_Module_Model::recalculateSharingRules();
	}
