...
global $default_language;
            if (ParsVT_Module_Model::LoginNews() && !defined("PARSVTIGER_WHITELABEL") && !file_exists('test/data/modules/ParsVT.offline') &&  vtlib_isModuleActive('ExtensionStore')  &&  !vtlib_isModuleActive('UserLogin') && $modelInstance) {
