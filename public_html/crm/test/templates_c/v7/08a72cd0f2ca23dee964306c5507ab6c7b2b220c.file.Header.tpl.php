<?php /* Smarty version Smarty-3.1.7, created on 2025-01-18 15:13:58
         compiled from "/home/mahcenter/public_html/crm/includes/runtime/../../layouts/v7/modules/Vtiger/Header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1947389756678b93fe0f9806-85825797%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '08a72cd0f2ca23dee964306c5507ab6c7b2b220c' => 
    array (
      0 => '/home/mahcenter/public_html/crm/includes/runtime/../../layouts/v7/modules/Vtiger/Header.tpl',
      1 => 1736402616,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1947389756678b93fe0f9806-85825797',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_678b93fe132b0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_678b93fe132b0')) {function content_678b93fe132b0($_smarty_tpl) {?>
...
",  'admin' :"<?php echo $_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('is_admin');?>
...
" data-calendar="<?php if ($_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('parsvt_calendar')){?><?php echo $_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('parsvt_calendar');?>
<?php }else{ ?>gregorian<?php }?>" data-language="<?php echo $_smarty_tpl->tpl_vars['LANGUAGE']->value;?>
"" data-desktop="<?php if ($_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('parsvt_desktop')){?><?php echo $_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('parsvt_desktop');?>
<?php }else{ ?>0<?php }?>" data-user-decimalseparator="<?php echo $_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('currency_decimal_separator');?>
