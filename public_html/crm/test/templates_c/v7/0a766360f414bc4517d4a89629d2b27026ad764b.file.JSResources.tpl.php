<?php /* Smarty version Smarty-3.1.7, created on 2025-01-18 15:13:58
         compiled from "/home/mahcenter/public_html/crm/includes/runtime/../../layouts/v7/modules/Vtiger/JSResources.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1096609545678b93fecef9c3-69601518%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0a766360f414bc4517d4a89629d2b27026ad764b' => 
    array (
      0 => '/home/mahcenter/public_html/crm/includes/runtime/../../layouts/v7/modules/Vtiger/JSResources.tpl',
      1 => 1736402616,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1096609545678b93fecef9c3-69601518',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_678b93fed1a6b',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_678b93fed1a6b')) {function content_678b93fed1a6b($_smarty_tpl) {?>


<script type="text/javascript" src="<?php echo vresource_url('layouts/v7/modules/ParsVT/resources/Utils.js');?>
"></script><script type="text/javascript" src="<?php echo vresource_url('layouts/v7/modules/ParsVT/resources/Calendar.js');?>
"></script><script type="text/javascript" src="layouts/v7/lib/jquery/purl.js"></script><script type="text/javascript" src="layouts/v7/lib/jquery/select2/select2.min.js"></script><script type="text/javascript" src="layouts/v7/lib/jquery/select2/select2_locale_<?php echo substr($_smarty_tpl->tpl_vars['LANGUAGE']->value,0,2);?>
.js"></script><script type="text/javascript" src="layouts/v7/lib/jquery/jquery.class.min.js"></script><script type="text/javascript" src="<?php echo vresource_url('layouts/v7/lib/jquery/jquery-ui-1.11.3.custom/jquery-ui.js');?>
"></script><script type="text/javascript" src="layouts/v7/lib/todc/js/popper.min.js"></script><script type="text/javascript" src="layouts/v7/lib/todc/js/bootstrap.min.js"></script><script type="text/javascript" src="libraries/jquery/jstorage.min.js"></script><script type="text/javascript" src="layouts/v7/lib/jquery/jquery-validation/jquery.validate.min.js"></script><script type="text/javascript" src="layouts/v7/lib/jquery/jquery-validation/localization/messages_<?php echo substr($_smarty_tpl->tpl_vars['LANGUAGE']->value,0,2);?>
