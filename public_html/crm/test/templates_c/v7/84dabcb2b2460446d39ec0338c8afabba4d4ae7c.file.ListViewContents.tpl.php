<?php /* Smarty version Smarty-3.1.7, created on 2025-01-19 13:22:49
         compiled from "/home/mahcenter/public_html/crm/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1212141258678ccb715dfca3-18590564%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '84dabcb2b2460446d39ec0338c8afabba4d4ae7c' => 
    array (
      0 => '/home/mahcenter/public_html/crm/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewContents.tpl',
      1 => 1736402366,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1212141258678ccb715dfca3-18590564',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_678ccb7175e95',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_678ccb7175e95')) {function content_678ccb7175e95($_smarty_tpl) {?>
...
<?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='55'){?><?php echo vtranslate($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType()=='customdatetime'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType()=='sensitive'){?>
        <?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getDisplayValue($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value);?>

        <?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType()=='multicurrency'){?>
        <?php echo Vtiger_Multicurrency_UIType::getListViewDisplayValue($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getId(),$_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value,$_smarty_tpl->tpl_vars['DATA_ID']->value);?>

        <?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType()=='citiesfield'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType()=='countries'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType()=='userslist'){?>
        <?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getDisplayValue($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value);?>
<?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType()=='dsign'){?>
        <?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_RAWVALUE']->value!=''){?><img src="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_RAWVALUE']->value;?>
" width="150" height="80"><?php }?>
        <?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType()=='reference'&&strstr($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value,'rf_pcf_mrf')&&strpos($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value,'rf_pcf_mrf')=='0'){?>
        <?php echo ParsVT_MultiReference_Helper::getDisplayValue($_smarty_tpl->tpl_vars['DATA_ID']->value,$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getId(),$_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value);?>

        <?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType()=='futronic'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType()=='signotec'){?>
        <?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_RAWVALUE']->value!=''){?><img src="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_RAWVALUE']->value;?>
" style="max-width:150px; max-height:100px"><?php }?>
...
<?php $_smarty_tpl->tpl_vars['CURRENT_USER_MODEL'] = new Smarty_variable(Users_Record_Model::getCurrentUserModel(), null, 0);?>
								...
								<?php echo vtranslate('No %s found.','ParsVT',vtranslate($_smarty_tpl->tpl_vars['MODULE']->value,$_smarty_tpl->tpl_vars['MODULE']->value));?>
...
</a> <?php echo vtranslate('in','ParsVT');?>
