        ...
        <section class="col-lg-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">ویرایش آدرس {{ $address->name }}</h3>
                    <div class="box-tools">
                        <div class="input-group input-group-sm">
                            <a href="{{ route('admin.users.addresses.index', $address->user->id) }}" class="btn btn-default btn-sm">لیست آدرس‌های کاربر
                ...
                <div class="box-body">
                    <form action="{{ route('admin.addresses.update', $address->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        @method('patch')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="checkbox" name="is_default" id="is_default" value="1" data-toggle="toggle" data-onstyle="success" data-on="<i class='fa fa-check'></i> پیش فرض" data-off="<i class='fa fa-close text-red'></i> ثانویه"{{ old('is_default', $address->is_default) ? ' checked' : '' }}>
