        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="nav-tabs-custom no-shadow">
                    ...
                    <form method="post" action="{{ route('admin.articles.store') }}" role="form" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                                    ...
                                    <div class="col-md-10">
                                        <select id="faqs_id" name="faqs_id[]" class="form-control" multiple>
                                            ...
                                            @foreach($faqs as $id => $heading)
                                                <option value="{{ $id }}" {{ in_array($id, old('faqs_id', [])) == $id ? 'selected' : '' }}>{{ $heading }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-10">
                                        <select id="products_id" name="products_id[]" class="form-control" multiple>
                                            ...
                                            @foreach($products as $id => $name)
                                                <option value="{{ $id }}" {{ in_array($id, old('products_id', [])) == $id ? 'selected' : '' }}>{{ $name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-10">
                                        <select id="relate_id" name="relate_id[]" class="form-control" multiple>
                                            ...
                                            @foreach($articles as $id => $title)
                                                <option value="{{ $id }}" {{ in_array($id, old('relate_id', [])) == $id ? 'selected' : '' }}>{{ $title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select name="is_suggested" id="is_suggested" class="form-control">
                                            <option value="0"{{ (old('is_suggested') == 0 ? 'selected' : '') }}>خیر</option>
                                            <option value="1"{{ (old('is_suggested') == 1 ? 'selected' : '') }}>بله</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
