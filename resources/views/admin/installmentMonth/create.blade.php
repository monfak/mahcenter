        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">ایجاداقساط ماهیانه</h3>
                    <div class="box-tools">
                        <div class="input-group input-group-sm">
                            <a href="{{ route('admin.settings.installment.month.index') }}" class="btn btn-default btn-sm">لیست اقساط ماهیانه
                ...
                <div class="box-body">
                    <div class="nav-tabs-custom no-shadow">
                        ...
                        <form method="post" action="{{ route('admin.settings.installment.month.store') }}" role="form" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="tab-content">
                                <div id="tab_general" class="tab-pane active">
                                    <div class="form-group">
                                        <label for="title" class="col-md-2 control-label">تعداد ماه *</label>
                                        <div class="col-md-5">
                                            <input type="number" name="month" id="title" class="form-control" value="{{ old('month') }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
