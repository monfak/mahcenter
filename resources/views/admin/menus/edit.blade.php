...
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form method="post" action="{{ route('admin.menus.update', $menu->id) }}" role="form" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <small class="text-muted">لطفا این مورد را تنها در صورتی تغییر دهید که از عواقب آن اطمینان دارید.</small>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="is_active">وضعیت</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="checkbox" name="is_active" id="is_active" value="1" data-toggle="toggle" data-onstyle="success" data-on="<i class='fa fa-check'></i> فعال" data-off="<i class='fa fa-close text-red'></i> غیرفعال" data-width="125"{{ old('status', $menu->is_active) ? ' checked' : '' }}>
                        </div>
                    </div>
