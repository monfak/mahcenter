...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $('#orders').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin.orders.ajax') }}',
            columns: [
                {data: 'first_name', name: 'user.first_name'},
                {data: 'last_name', name: 'user.last_name'},
                {data: 'id', name: 'id'},
    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">لیست سفارش‌ها</h3>
                <div class="box-tools">
                    <div class="input-group input-group-sm">
                        <a href="{{ route('admin.orders.create') }}" class="btn btn-default btn-sm">
                            <span class="fa fa-plus"></span> افزودن سفارش
                        </a>
                    </div>
                </div>
            </div>
