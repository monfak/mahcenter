        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">ویرایش صفحه</h3>
                    <div class="box-tools">
                ...
                <div class="box-body">
                    <div class="nav-tabs-custom no-shadow">
                        ...
                        <form method="post" action="{{ route('admin.pages.update', $page->id) }}" role="form" enctype="multipart/form-data" class="form-horizontal">
                            @csrf
                            @method('PATCH')
                            <div class="tab-content">
                                <div id="tab_general" class="tab-pane active">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="heading" id="heading" class="form-control" value="{{ old('heading', $page->heading)}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div id="tab_seo" class="tab-pane">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="twitter_title" id="twitter_title" class="form-control" value="{{ old('twitter_title', $page->twitter_title) }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="twitter_description" class="col-md-2 control-label">دسکریپشن برای توئیتر</label>
                                        <div class="col-md-10">
                                            <textarea name="twitter_description" id="twitter_description" class="form-control" rows="5">{{ old('twitter_description', $page->twitter_description) }}</textarea>
                                        </div>
                                    </div>
                                    @if($page->og_image)
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <img src="{{ asset(image_resize($page->og_image, ['width' => 60, 'height' => 60])) }}" alt="{{ $page->name }}">
                                        </div>
                                    </div>
                                    @endif
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <img src="{{ asset(image_resize($page->twitter_image, ['width' => 60, 'height' => 60])) }}" alt="{{ $page->name }}">
                                        </div>
                                    </div>
                                    @endif
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="canonical" id="canonical" class="form-control" value="{{ old('canonical', $page->canonical) }}" dir="ltr">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="is_nofollow" class="col-md-2 control-label mt-2">نوفالو</label>
                                        <div class="col-md-10">
                                            <input type="checkbox" name="is_nofollow" id="is_nofollow" value="1" data-width="100" data-toggle="toggle" data-onstyle="danger" data-on="<i class='fa fa-close'></i> نوفالو" data-off="<i class='fa fa-check'></i> فالو"{{ old('is_nofollow', $page->is_nofollow) ? ' checked' : '' }}>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="is_noindex" class="col-md-2 control-label mt-2">نوایندکس</label>
                                        <div class="col-md-10">
                                            <input type="checkbox" name="is_noindex" id="is_noindex" value="1" data-width="100" data-toggle="toggle" data-onstyle="danger" data-on="<i class='fa fa-close'></i> نوایندکس" data-off="<i class='fa fa-check'></i> ایندکس"{{ old('is_noindex', $page->is_noindex) ? ' checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                                <div id="tab_information" class="tab-pane">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <img src="{{ asset(image_resize($page->image, ['width' => 60, 'height' => 60])) }}" alt="{{ $page->title }}">
                                        </div>
                                    </div>
                                    @endif
                                    <div class="form-group">
                                        <label for="image" class="col-md-2 control-label">{{ ($page->image ? 'تغییر تصویر' : 'تصویر') }}</label>
                                        <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <select name="status" id="status" class="form-control">
                                                <option value="0"{{ (old('status', $page->status) == 0 ? 'selected' : '') }}>پیش‌نویس</option>
                                                <option value="1"{{ (old('status', $page->status) == 1 ? 'selected' : '') }}>انتشار</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
