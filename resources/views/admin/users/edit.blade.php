                ...
                <div class="box-body">
                    <form action="{{ route('admin.users.update', $user->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input id="email" type="email" class="form-control" name="email" value="{{ old('email', $user->email) }}" dir="ltr">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input id="mobile" type="text" class="form-control" name="mobile" value="{{ old('mobile', $user->mobile) }}" dir="ltr">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input id="password" type="password" class="form-control" name="password" dir="ltr">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input id="national_code" type="text" class="form-control" name="national_code" value="{{ old('national_code', $user->national_code) }}" dir="ltr">
