...
@section('title', $site_settings['amazing_title'])
@section('description', $site_settings['amazing_description'])
@section('content')
    <div class="container container-pro">
        <div class="row mt-4 mb-4">
            <div class="col-12 p-0">
                 <h1 class="title-section text-center">{{ $site_settings['amazing_heading'] }}</h1>
            </div>
        </div>
        <div class="row mt-4 mb-4">
